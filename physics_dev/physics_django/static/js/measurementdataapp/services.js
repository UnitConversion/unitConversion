...
app.factory('bmFactory', function($http, $q, BendingMagnet){
	...
	factory.updateItem = function(params) {
		...
		params = prepareUrlParameters(factory.bm.update, params);
		var deffered = $q.defer();
		var promise = deffered.promise;
	...
	factory.updateDevice = function(params) {
		...
		params = prepareUrlParameters(factory.bm.update_device, params);
		l(params);
		var deffered = $q.defer();
		var promise = deffered.promise;
	...
	factory.approveItem = function(params) {
		...
		params = prepareUrlParameters(factory.bm.approve, params);
		var deffered = $q.defer();
		var promise = deffered.promise;
...
app.factory('idFactory', function($http, $q, InsertionDevice){
	...
	factory.updateItem = function(params) {
		...
		params = prepareUrlParameters(factory.idO.update, params);
		var deffered = $q.defer();
		var promise = deffered.promise;
	...
	factory.updateDevice = function(params) {
		...
		params = prepareUrlParameters(factory.idO.update_device, params);
		l(params);
		var deffered = $q.defer();
		var promise = deffered.promise;
	...
	factory.approveItem = function(params) {
		...
		params = prepareUrlParameters(factory.idO.approve, params);
		var deffered = $q.defer();
		var promise = deffered.promise;
...
app.factory('logicFactory', function($http, $q, Logic){
	...
	factory.updateItem = function(params) {
		...
		params = prepareUrlParameters(factory.logic.update, params);
		var deffered = $q.defer();
		var promise = deffered.promise;
