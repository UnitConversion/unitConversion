...
app.value('InsertionDevice', function(obj) {
	...
	// Save parameters in data
	this.save_data = ["cell", "type", "set", "str_sect", "defined_by", "pos", "pos_from_cent", "x_max_offset", "x_max_angle", "x_extra_offset", "x_lat_name_s1", "x_lat_pos_s1", "x_pos_from_cent_s1", "x_offset_s1", "x_logic_1", "x_lat_name_s2", "x_lat_pos_s2", "x_pos_from_cent_s2", "x_offset_s2", "x_lat_pos_s3", "x_pos_from_cent_s3", "x_offset_s3", "x_logic_2", "x_angle", "y_max_offset", "y_max_angle", "y_extra_offset", "y_lat_name_s1", "y_lat_pos_s1", "y_pos_from_cent_s1", "y_offset_s1", "y_logic_1", "y_lat_name_s2", "y_lat_pos_s2", "y_pos_from_cent_s2", "y_offset_s2", "y_lat_pos_s3", "y_pos_from_cent_s3", "y_offset_s3", "y_logic_2", "y_angle", "safe_current"];
	
	// Parameters that are displayed for saving
	this.save_display = ["cell", "type", "set", "str_sect", "logic", "shape", "defined_by", "name", "pos", "pos_from_cent", "x_max_offset", "x_max_angle", "x_extra_offset", "x_lat_name_s1", "x_lat_pos_s1", "x_pos_from_cent_s1", "x_offset_s1", "x_logic_1", "x_lat_name_s2", "x_lat_pos_s2", "x_pos_from_cent_s2", "x_offset_s2", "x_lat_pos_s3", "x_pos_from_cent_s3", "x_offset_s3", "x_logic_2", "x_angle", "y_max_offset", "y_max_angle", "y_extra_offset", "y_lat_name_s1", "y_lat_pos_s1", "y_pos_from_cent_s1", "y_offset_s1", "y_logic_1", "y_lat_name_s2", "y_lat_pos_s2", "y_pos_from_cent_s2", "y_offset_s2", "y_lat_pos_s3", "y_pos_from_cent_s3", "y_offset_s3", "y_logic_2", "y_angle", "safe_current"];
