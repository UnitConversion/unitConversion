...
from idods.views import (retrieveVendorWS, saveVendorWS, updateVendorWS)
from idods.views import (retrieveCompntTypePropTypeWS, saveCompntTypePropTypeWS, updateCmpntTypePropTypeWS)
from idods.views import (retrieveCompntTypeWS, saveCompntTypeWS, updateCmpntTypeWS)
from idods.views import (retrieveInventoryWS, retrieveInventoryByIdWS, saveInventoryWS, updateInventoryWS)
from idods.views import (retrieveInventoryPropWS, saveInventoryPropWS, updateInventoryPropWS)
from idods.views import (retrieveInventoryPropTmpltWS, saveInventoryPropTmpltWS, updateInventoryPropTmpltWS)
from idods.views import (retrieveInstallWS, saveInstallWS, updateInstallWS)
from idods.views import (retrieveInstallRelWS, saveInstallRelWS, updateInstallRelWS, deleteInstallRelWS)
from idods.views import (retrieveInstallRelPropTypeWS, saveInstallRelPropTypeWS, updateInstallRelPropTypeWS)
from idods.views import (saveInstallRelPropWS, updateInstallRelPropWS)
from idods.views import (retrieveInventoryToInstallWS, saveInventoryToInstallWS, updateInventoryToInstallWS, deleteInventoryToInstallWS)
from idods.views import (retrieveDataMethodWS, saveDataMethodWS, updateDataMethodWS)
from idods.views import (retrieveRawDataWS, saveRawDataWS)
from idods.views import (retrieveOfflineDataWS, retrieveOfflineDataInstallWS, saveOfflineDataWS, updateOfflineDataWS, deleteOfflineDataWS)
from idods.views import (uploadFileWS)
from idods.views import (retrieveOnlineDataWS, saveOnlineDataWS, updateOnlineDataWS, deleteOnlineDataWS)
from idods.views import (testAuth, testCall, saveInsertionDeviceWS)
from idods.views import (idodsInstallWS)
from idods.views import (retrieveTreesWS)
from idods.views import (saveDataMethodOfflineDataWS)
from idods.views import (retrieveRotCoilDataWS, saveRotCoilDataWS, updateRotCoilDataWS, deleteRotCoilDataWS)
from idods.views import (retrieveHallProbeDataWS, saveHallProbeDataWS, updateHallProbeDataWS, deleteHallProbeDataWS)
from idods.views import (retrieveCmpntTypeRotCoilDataWS, saveCmpntTypeRotCoilDataWS, updateCmpntTypeRotCoilDataWS, deleteCmpntTypeRotCoilDataWS)
from idods.views import (retrieveCmpntTypeHallProbeDataWS, saveCmpntTypeHallProbeDataWS, updateCmpntTypeHallProbeDataWS, deleteCmpntTypeHallProbeDataWS)
from idods.views import (idodsIndexHtml, idodsHtmls)
from idods.views import (measurementIndexHtml, measurementHtmls)
