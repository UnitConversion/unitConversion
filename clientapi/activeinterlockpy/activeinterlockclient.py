...
class ActiveInterlockClient(object):
    ...
    def __init__(self, BaseURL=None, username=None, password=None):
        ...
        self.__aiResource = '/activeinterlock/'
        ...
        try:
            ...
            if username and password:
                ...
                self.__auth = None
            requests.get(self.__baseURL + self.__aiResource, verify=False, headers=copy(self.__jsonheader)).raise_for_status()
            self.client = requests.session()
        except:
            raise Exception, 'Failed to create client to ' + self.__baseURL + self.__aiResource
    ...
    def retrieveactiveinterlock(self, status, datefrom=None, dateto=None, withdata=True, rawdata=False):
        ...
        resp=self.client.get(self.__baseURL+self.__aiResource, 
                             params=params,
    ...
    def saveactiveinterlock(self, data, description=None, datafile=None, active=True, author=None):
        ...
        resp=self.client.post(self.__baseURL+self.__aiResource, 
                              data=payload,
                              headers=copy(self.__jsonheader),
                              verify=False,
                              auth=self.__auth)
